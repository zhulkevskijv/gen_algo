class Run:
    def __init__(self, avg_fitness_list=None, std_fitness_list=None, pressure_stats=None, reproduction_stats=None, selection_diff_stats=None, noise_stats=None, is_successful=None, best_fitness_list=None, optim_num_list=None):
        ...
        self.optim_num_list = optim_num_list
#%%
